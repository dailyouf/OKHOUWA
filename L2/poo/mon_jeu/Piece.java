...
public class Piece {
	...
	*/
	 ...
	 * 
	*/
	public boolean retirerObjet(ObjetZork objet) {
		return l.remove(objet);
	}
	
	/**
	 * Revoie si notre pièce contient un objet
	 * @param l'objet dont en vérifie l'appartenance 
	 * @return <code>true<\code>	uniquement si l'objet est dans la piece
	 * 
	*/
	...
	*/
	...
	/**
	 * Revoie le nombre d'occurrence d'un objet dans la piece
	 * @param l'objet dont on veut compter l'occurrence
	 *
	 * @return l'occurrence de l'objet donné en paramètre dans la piece 
	 *
	*/
